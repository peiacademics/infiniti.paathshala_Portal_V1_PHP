...
<table width="100%" border="1px">
  ...
  <tr>
    <td width="25%" style="font-size: 12px;">Email ID:</td>
...
<table border="0" align="center" width="100%">
 ...
 <br>
  ...
  <table width="100%" border="1px" style="padding: 8px;font-size:12px;">
    ...
    <tr>
      <td colspan="5"><p style="font-size: 12px;">Total Paid After this Installment - <?php echo @$DETAIL['referal']['paid']; ?> & Balance After this Installment - <?php echo @$DETAIL['referal']['pending']; ?></p></td>
    </tr>
  </table>
