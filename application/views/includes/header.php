...
<html>
    ...
    <body class="skin-1 <?php echo ($this->session_library->get_session_data('Login_as') == 'DSSK10000001') ? '' : 'fixed-sidebar'; ?>"><!-- <?php// echo ($this->session_library->get_session_data('Login_as') != 'DSSK10000001') ? '' : 'mini-navbar'; ?> -->
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        ?>
                <li class="" id="<?php echo 'A'.md5(base_url(@$one['link'])); ?>">
                    <a href="<?php echo base_url(@$one['link']); ?>">
                        <?php if($one['icon'] === 'TH') { ?>
                            <h4>THA</h4>
                        <?php } else { ?>
                            <i class="fa fa-<?php echo $one['icon']?>"></i>
                        <?php } ?>
                         <span class="nav-label"><?php echo $this->lang_library->translate($one['title']); ?></span><span class="fa arrow"></span>
                    </a>
