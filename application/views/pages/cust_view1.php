...
<div class="page-content">
      ...
      <div id="data_table table-responsive" class="">
        ...
        <table id='dataTable' class="table someclass" cellspacing="0" >
            ...
            <td class="issue-info">
              <h3>
                ...
                <small>
                   ...
                   <a class="btn btn-primary btn-outline dim" onclick="getDetails('<?php echo $value['ID']; ?>')"> <i class="fa fa-pencil"></i></a>
                   <a class="btn btn-success btn-outline dim" onClick="call_recs('<?php echo $value['ID']; ?>')"> <i class="fa fa-eye"></i></a>
                   <a class="btn btn-warning btn-outline dim" onclick="send_sms('<?php echo $value['ID']; ?>')"> <i class="fa fa-comment"></i></a>
                </small>
                <br>
                <!-- <div class="smlBtn"> -->
          ...
          <?php } } else { ?>
            <tr><td colspan="4"><div class="text-danger text-center h3 container">No records found.</div></td></tr>
          <?php } ?>
        </table>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  var lists = "<?php echo count($lists['recs']); ?>";
  if(lists > 0)
  {
    var listID = "<?php echo $lists['recs'][0]['list_ID'];?>";
    getCount(listID);
  }
...
{
  var cnt = '<?php echo count($lists['recs']); ?>';
  var i;
  for (var i = 0; i < cnt; i++) 
  {
    if (i == c) 
