...
function view(id)
{
  $.ajax({
    ...
    success:function(response)
    {
      ...
      data += '<tfooter><tr><td colspan="2" class="text-center"><button type="button" id="cls" class="btn btn-lg btn-danger" data-dismiss="modal">Close</button> <button id="cmt" type="button" class="btn btn-lg btn-success" onClick="commun(\''+id+'\');">Communicate Communicate Employee Notice</button></td></tr></tfooter></table>';
