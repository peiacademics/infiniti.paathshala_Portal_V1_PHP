 ...
 <div class="page-content">
      <div class="row">
        <div class="ibox">
          <!-- <div class="ibox-title">
              <h5><?php echo ucfirst($this->lang_library->translate('Leads')); ?></h5>
      ...
      <div id="data_table" class="">
        <table id='dataTable' class="table" cellspacing="0" >
          ...
          <?php
        if (!empty($lists['recs'])) {
          foreach ($lists['recs'] as $key => $value) { ?>
          <tr>
            <td><!--  class="col-sm-1" -->
              <div class="col-sm-1">
               <img src="<?php echo base_url('impImg/leads.jpg'); ?>" height="50" width="75">
              </div>
            <!-- </td>
            <td class="feed-element"> -->
              <div class="feed-element col-sm-7">
              <h3>
                <a href="#" onClick="get_call_details('<?php echo $value['ID'];?>')" id="no<?php echo $value['ID'];?>">
                ...
                <span class="label label-warning-light "><?php echo $value['recall']?> Recall</span><br><br>
                ...
                <button class="btn btn-outline btn-warning dim" onClick="send_sms('<?php echo $value['ID']; ?>')"> <i class="fa fa-comment"></i></button>
                </div>
            <!-- </td>
            ...
            <div class="col-sm-4">
              <div class="smlBtn visible-sm visible-xs">
                  <div id="time<?php echo $value['ID']; ?>"></div>
                    <?php if ($value['cust_calls']['call_Status']==='recall') {
                 ...
                 <?php    } ?>
              <?php if ($value['cust_calls']['call_Status']==='blank') { ?>
              <div id="<?php echo $value['ID'];?>">
                <a class="btn btn-primary btn-sm-block" onclick="addIcons('<?php echo $value['ID']; ?>','called')"> <i class="fa fa-phone"></i> Call</a><span></span>
              </div>
              <?php }else if($value['cust_calls']['call_Status']==='called'){ ?>
              <div id="<?php echo $value['ID'];?>">
                <a class="btn btn-primary btn-sm-block" onclick="addIcons('<?php echo $value['ID']; ?>','accept')"> <i class="fa fa-phone"></i> Accept</a>
                <a class="btn btn-danger btn-sm-block" onclick="addIcons('<?php echo $value['ID']; ?>','reject')"> <i class="fa fa-phone fa-rotate-90"></i> Reject</a>
                <a class="btn btn-warning btn-sm-block" onclick="addIcons('<?php echo $value['ID']; ?>','noResponce')"> <i class="fa fa-phone"></i> No Responce</a>
              </div>
              <?php }else if($value['cust_calls']['call_Status']==='accept'){ ?>
              <div id="<?php echo $value['ID'];?>">
              ...
              <?php }else if($value['cust_calls']['call_Status']==='noResponce' || $value['cust_calls']['call_Status']==='reject'){ ?>
               <div id="<?php echo $value['ID'];?>">
                <!-- <a class="btn btn-primary" onclick="Recall('<?php //echo $value['ID']; ?>','recall','<?php //echo $value['contact_No']; ?>')"> <i class="fa fa-phone"></i> Recall</a> -->
                <a class="btn btn-primary btn-block" onclick="addIcons('<?php echo $value['ID']; ?>','called')"> <i class="fa fa-phone"></i> Call</a><span></span>
                <a class="btn btn-danger btn-block" onclick="addIcons('<?php echo $value['ID']; ?>','abort')"> <i class="fa fa-ban"></i> Not Interested</a>
              </div>
              <?php }else if($value['cust_calls']['call_Status']==='abort'){ ?>
               <!-- <div id="<?php //echo $value['ID'];?>">
                <a class="btn btn-warning" readonly > <i class="fa fa-times"></i> Close</a>
              </div> -->
                <a class="btn btn-primary btn-block" onclick="Recall('<?php echo $value['ID']; ?>','recall','<?php echo $value['contact_No']; ?>')"> <i class="fa fa-phone"></i> Recall</a>
              <?php }else if($value['cust_calls']['call_Status']==='lead'){ ?>
                <div id="<?php echo $value['ID'];?>">
                   <a class="btn btn-primary btn-block" onclick="Recall('<?php echo $value['ID']; ?>','recall','<?php echo $value['contact_No']; ?>')"> <i class="fa fa-phone"></i> Recall</a>
                  <a class="btn btn-success btn-block" onclick="addIcons('<?php echo $value['ID']; ?>','lead')"> <i class="fa fa-plus"></i> Lead</a>
                  <a class="btn btn-default btn-block" onclick="addIcons('<?php echo $value['ID']; ?>','customer')"> <i class="fa fa-user"></i> Customer</a>
              ...
              <?php } else if($value['cust_calls']['call_Status']==='customer') { ?>
                <div id="<?php echo $value['ID'];?>">
                  <a class="btn btn-success btn-block disabled"> <i class="fa fa-tick"></i> Added in Customer</a>
                </div>
              <?php }else if($value['cust_calls']['call_Status']==='recall'){ ?>
                <div id="<?php echo $value['ID'];?>">
              ...
              <?php }else if($value['cust_calls']['call_Status']==='noResponce' || $value['cust_calls']['call_Status']==='reject'){ ?>
               <div id="c-<?php echo $value['ID'];?>">
                <a class="btn btn-primary" onclick="addIcons('<?php echo $value['ID']; ?>','called')"> <i class="fa fa-phone"></i> Call</a> <span></span>
                <a class="btn btn-danger" onclick="addIcons('<?php echo $value['ID']; ?>','abort')"> <i class="fa fa-ban"></i> Not Interested</a>
              </div>
              <?php }else if($value['cust_calls']['call_Status']==='abort'){ ?>
                <a class="btn btn-primary btn-block" onclick="Recall('<?php echo $value['ID']; ?>','recall','<?php echo $value['contact_No']; ?>')"> <i class="fa fa-phone"></i> Recall</a>
              <?php }else if($value['cust_calls']['call_Status']==='lead'){ ?>
...
<div class="modal inmodal" id="reasonModal" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  <div class="modal-content animated bounceInRight">
          ...
          <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" id="closeReason">Close</button> 
...
function addIcons(id,status,id1,k){
  ...
  else
  {
    $.ajax({
      ...
      dataType: "json",
      url: '<?php echo base_url();?>customer/lead_call_status',
      success:function(response)
      {
       // response=JSON.parse(response);
        if (status==='called'){
...
function addIcons2(id,status,id1,k){
  // showno(id1,k);
  $('#'+id).html('');
  $('#c-'+id).html('');
  $('#'+id).append('<h3><i class="fa fa-spinner fa-pulse"></i> Loading</h3>');
    ...
    console.log(typeof response);
      if (status==='called'){
        ...
        if (typeof response==='object'){
          ...
          $('#c-'+id).html('');
          $('#icn'+id).addClass('text-warning').html('<i class="fa fa-check-circle-o"></i>');
          $('#'+id).append('<a class="btn btn-primary btn-block" onclick="Recall(\''+response.ID+'\',\'recall\',\''+response.contact_No+'\')"> <i class="fa fa-phone"></i> Recall</a>&nbsp;<a class="btn btn-success" onclick="addIcons(\''+response.ID+'\',\'lead\')"> <i class="fa fa-plus"></i> Lead</a>&nbsp;<a class="btn btn-default btn-block" onclick="addIcons(\''+response.ID+'\',\'customer\')"> <i class="fa fa-user"></i> Customer</a>&nbsp;<a class="btn btn-danger btn-block" onclick="addIcons(\''+response.ID+'\',\'abort\')"> <i class="fa fa-ban"></i> Not Interested</a>');
          $('#c-'+id).append('<a class="btn btn-primary btn-block" onclick="Recall(\''+response.ID+'\',\'recall\',\''+response.contact_No+'\')"> <i class="fa fa-phone"></i> Recall</a>&nbsp;<a class="btn btn-success" onclick="addIcons(\''+response.ID+'\',\'lead\')"> <i class="fa fa-plus"></i> Lead</a>&nbsp;<a class="btn btn-default btn-block" onclick="addIcons(\''+response.ID+'\',\'customer\')"> <i class="fa fa-user"></i> Customer</a>&nbsp;<a class="btn btn-danger btn-block" onclick="addIcons(\''+response.ID+'\',\'abort\')"> <i class="fa fa-ban"></i> Not Interested</a>');
          $('#no'+id).removeAttr('href');
          $('#no'+id).removeAttr('onclick');
        }else
...
$('#addRecall').on('click',function(e) {
  ...
  $.ajax({
    ...
    data:formdata,
     dataType: "json",
    url: '<?php echo base_url(); ?>'+'customer/recall/',
    success:function(response)
    {
...
function Recall(id,status,no)
{
  ...
  $.ajax({
    type:'POST',
    dataType: "json",
    url: '<?php echo base_url(); ?>'+'customer/call_recs/'+id,
    success:function(response)
    {
      if (typeof response === 'object'){
        // $(".customscrollbar").mCustomScrollbar({
