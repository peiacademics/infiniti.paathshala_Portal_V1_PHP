 <div class="page-content">
        ...
        <div class="ibox">
          ...
          <div class="ibox-title">
              ...
              <h5><?php echo ucfirst($this->lang_library->translate('Branch')); ?></h5>
          ...
          <a href="<?php echo base_url('Branch/add'); ?>" class="btn btn-w-m btn-primary">Add Branch</a>      
...
$(document).ready(function() {
    ...
    oTable = $('#example').DataTable( {
        ...
        "ajax": "<?php echo base_url('Branch/get_show_data'); ?>",
...
{ 
    ...
    url: '<?php echo base_url(); ?>'+'Branch/view/'+id,
