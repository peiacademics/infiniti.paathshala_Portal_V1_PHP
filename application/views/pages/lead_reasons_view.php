  ...
  <div class="wrap">
    <div class="ibox">
      <div class="ibox-title">
        <h5><?php echo ucfirst($this->lang_library->translate('Lead Reasons')); ?></h5>
      ...
      <div class="ibox-content table-responsive">
        <div>
          <a href="<?php echo base_url('lead_reasons/add'); ?>" class="btn btn-w-m btn-primary">Add Lead Reason</a>
        </div>
        <hr>
...
<script type="text/javascript">
  $(document).ready(function() {
    oTable = $('#example').DataTable( {
      "processing": true,
      "serverSide": true,
      "ajax": "<?php echo base_url('lead_reasons/get_show_data'); ?>",
      "dom": 'lBftipB',
      "buttons": [
  ...
  { 
    $.ajax({
      type:'POST',
      url: '<?php echo base_url(); ?>'+'lead_reasons/view/'+id,
