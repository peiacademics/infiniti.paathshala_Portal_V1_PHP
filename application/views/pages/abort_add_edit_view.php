<div class="row">
  <!-- <div class="ibox-title">
    <h5><?php echo ucfirst($this->lang_library->translate('Add Abort Reason')); ?></h5>
  ...
  <div class="ibox-content">
    <div class="page-content">
      <div class="wrap">
        ...
        <form class="form-horizontal" role="form" action="<?php echo base_url('abort/add'); ?>" method="post" id="abort_add">
          <input type="hidden" name="ID" value="<?php echo @$View['ID'];?>">
            <div class="form-group">
              <label  class="col-sm-3 control-label">Abort Reason : </label>
              <div class="col-sm-6">
                <textarea type="text" class="form-control" id="Name" placeholder="Reason" name="reason" value=""><?php echo @$View['reason']; ?></textarea>
              </div>
              <span id="reason"></span>
            </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#abort_add").postAjaxData(function(result){
      if(result === 1)
      {
