 <div class="page-content">
    <div class="pull-right">
      <a href="<?php echo base_url('task_type/add'); ?>"><button typer="button" class="btn btn-w-m btn-primary dim btn-outline"><i class="fa fa-plus"></i> Add Department</button></a>
    </div>
    <div class="row">
        ...
        <div class="ibox">
          ...
          <!-- <div class="ibox-title">
              ...
              <h5><?php echo ucfirst($this->lang_library->translate('Departments')); ?></h5>
          ...
          <div class="ibox-content table-responsive">
            ...
            <!-- <div>
              ...
              <a href="<?php echo base_url('task_type/add'); ?>" class="btn btn-w-m btn-primary">Add Deparment</a>
...
$(document).ready(function() {
    ...
    oTable = $('#example').DataTable( {
        ...
        "ajax": "<?php echo base_url('task_type/get_show_data'); ?>",
...
{ 
    ...
    url: '<?php echo base_url(); ?>'+'task_type/view/'+id,
