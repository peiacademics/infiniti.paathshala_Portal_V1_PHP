 <div class="page-content">
        ...
        <div class="ibox">
          ...
          <div class="ibox-title">
              ...
              <h5><?php echo ucfirst($this->lang_library->translate('Bank Accounts')); ?></h5>
          ...
          <div class="ibox-content table-responsive">
            ...
            <div>
              ...
              <a href="<?php echo base_url('bank/add'); ?>" class="btn btn-w-m btn-primary">Add Bank Account</a>
...
$(document).ready(function() {
    ...
    oTable = $('#example').DataTable( {
        ...
        "ajax": "<?php echo base_url('bank/get_show_data'); ?>",
...
{ 
    ...
    url: '<?php echo base_url(); ?>'+'bank/view/'+id,
