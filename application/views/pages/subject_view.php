 <div class="page-content">
        ...
        <div class="pull-right">
          <a href="<?php echo base_url('Subject/add'); ?>"><button typer="button" class="btn btn-w-m btn-primary dim btn-outline"><i class="fa fa-plus"></i> Add Subject</button></a>
        </div>
        <div class="ibox">

          <!-- <div class="ibox-title">

              <h5><?php echo ucfirst($this->lang_library->translate('Subject')); ?></h5>
          ...
          <div class="ibox-content table-responsive">
            ...
            <!-- <div>
              ...
              <a href="<?php //echo base_url('Subject/add'); ?>" class="btn btn-w-m btn-primary">Add Subject</a>
