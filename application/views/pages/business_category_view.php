 <div class="page-content">
    ...
    <div class="row">
        <div class="pull-right">
          <a href="<?php echo base_url('Business_category/add'); ?>"><button typer="button" class="btn btn-w-m btn-primary dim btn-outline"><i class="fa fa-plus"></i> Add Vendor Category</button></a>
        </div>
        <div class="ibox">

          <!-- <div class="ibox-title">

              <h5><?php echo ucfirst($this->lang_library->translate('Vendor Categories')); ?></h5>
          ...
          <div class="ibox-content table-responsive">
           ...
           <!--  <div>
              ...
              <a href="<?php echo base_url('Business_category/add'); ?>" class="btn btn-w-m btn-primary">Add Vendor Category</a>
...
$(document).ready(function() {
    ...
    oTable = $('#example').DataTable( {
        ...
        "ajax": "<?php echo base_url('Business_category/get_show_data'); ?>",
...
{ 
    ...
    url: '<?php echo base_url(); ?>'+'Business_category/view/'+id,
