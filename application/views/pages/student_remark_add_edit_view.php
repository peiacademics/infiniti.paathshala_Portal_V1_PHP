...
<div class="ibox">
  <div class="ibox-title">
      <h5><?php echo ucfirst($this->lang_library->translate('Add Student Remark')); ?></h5>
...
<div class="page-content">
            <div class="wrap">
              <h4 id="success" style="text-align:center;"></h4>
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo base_url('student_remark/add'); ?>" method="post" id="remark_add">
                        ...
                        <div class="form-group">
                          <label  class="col-sm-3 control-label">Remark Title : </label>
                          <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <textarea class="form-control" name="remark" id="remark" rows="10"><?php echo @$View['remark']; ?></textarea>
                          </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#remark_add").postAjaxData(function(result){
      if(result == true)
      {
