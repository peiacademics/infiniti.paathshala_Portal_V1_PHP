...
<div class="ibox">
  <div class="ibox-title">
      <h5><?php echo ucfirst($this->lang_library->translate('Add Syllabus Coverage')); ?></h5>
...
<div class="page-content">
            <div class="wrap">
              <h4 id="success" style="text-align:center;"></h4>
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo base_url('syllabus_coverage/add'); ?>" method="post" id="assignment_add">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="chapter_no" placeholder="Chapter Number" name="chapter_no" value="<?php echo @$View['chapter_no']; ?>" required>
                          </div>
                          <span id="chapter_no"></span>
                        </div>

                       <div class="form-group">
                        <label  class="col-sm-3 control-label">Lesson: </label>
                        <div class="col-sm-6">
                          <select class="form-control chosen-select selectKeyword" id="chapter" name="chapter[]" placeholder="Lesson" required multiple>
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 control-label">Select Professor : </label>
                          <div class="col-sm-6">
                            <select class="form-control chosen-select" id="proff_ID" placeholder="Professor" name="proff_ID[]" value="<?php @$View['proff_ID']; ?>" multiple required>
                            </select>
                          </div>
                        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    getChosenData('proff_ID','US',[{'label':'Name','value':'ID'}],[{'Status':'A','branch_ID':br_id}],'<?php echo @$View['proff_ID']; ?>',true);
 ...
 function get_lesson()
  ...
  function commun(id)
  {
    $.ajax({
      ...
      method:'POST',
      data:{ID:id,rec_id:'CMSSK10000009',tbl:'SC'},
      datatype:'JSON',
      success:function(response){
