 <div class="page-content">
      ...
      <div class="row">
        <div class="pull-right">
         <a href="<?php echo base_url('Lesson/add'); ?>"><button typer="button" class="btn btn-w-m btn-primary dim btn-outline"><i class="fa fa-plus"></i> Add Chapter</button></a>
        </div>
        ...
        <div class="ibox">
          ...
          <!-- <div class="ibox-title">
              ...
              <h5><?php echo ucfirst($this->lang_library->translate('Chapter')); ?></h5>
...
$(document).ready(function() {
    ...
    oTable = $('#example').DataTable( {
        ...
        "ajax": "<?php echo base_url('Lesson/get_show_data'); ?>",
...
{ 
    ...
    url: '<?php echo base_url(); ?>'+'SLesson/view/'+id,
