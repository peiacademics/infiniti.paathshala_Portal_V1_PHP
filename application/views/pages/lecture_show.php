...
function showClassData(response ,id) {
  ...
  if (response !== null) {
    ...
    $.each(response,function(key,val) {
      ...
      data += "<div class='feed-element' id='classes"+val.id+"'><a href='profile.html' class='pull-left'><img alt='image' class='img-circle' src='"+base_url+val.imageurl+"'></a><div class='media-body'><small class='pull-right'></small><a href='"+base_url+"Team/view/"+val.EmpID+"'><strong>"+val.EmpName+"</strong></a> is conducting a lecture of <strong>"+seprtn[0]+"</strong> on <strong class='text-primary'>"+moment(val.date).format("MMMM Do YYYY, h:mm a")+"</strong> for <strong>"+seprtn[1]+"</strong>. <br><small class='text-muted'>Scheduled from Date "+moment(val.start_date).format("MMMM Do YYYY")+" to "+moment(val.end_date).format("MMMM Do YYYY")+" on Time "+val.time+"</small>";
      if(val.lect_ID != null)
      {
        data += "<br><div class='pull-left well'><span class='h4'><i class='fa fa-sticky-note' aria-hidden='true'></i><br>Covered <b>"+val.chapter_name+"</b> having <b>"+val.topic+"</b></span><br><small class='h5'>"+val.description+"</small></div>";
      }
      data += "<div class='pull-right'><a class='btn btn-xs btn-primary' href='#tab-5' data-toggle='tab' onClick='edit("+JSON.stringify(val)+");'><i class='fa fa-pencil'></i> Edit </a></div></div></div>";
    });
    ...
    $.ajax({
        ...
        success:function(result)
        {
          if(typeof result === 'object')
          {
            ...
            {
              fetchCalDataClass();
              $('#cmt').attr('onclick','commun("'+result.id+'","'+result.lect_ID+'")');
                                  ...
                                  <div class="panel-body">
                                    ...
                                    <div class="row">
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" id="Date" class="form-control daterange" name="Date" placeholder="Date" value="" disabled>
                                    ...
                                    <div class="row">
                                    	<div class="form-group">
  			                                ...
  			                                <div class="col-sm-9">
                                          <input type="text" class="form-control modalTime" id="Time" name="Time" placeholder="From Time" value="" disabled>
                                    ...
                                    <div class="row">
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                          <input type="text" class="form-control modalTime" id="Totime" name="Totime" placeholder="To Time" value="" disabled>
                                        </div>
                                      </div>
                                    </div>
  			                            <br>
  			                            <div class="row">
  			                              <div class="form-group">
  			                                ...
  			                                <div class="col-sm-9">
  			                                  <select class="form-control chosen-select" id="classs" name="Class_ID[]" multiple disabled onChange="get_all_students()">
  	  										                </select>
  			                                </div>
  			                              </div>
  			                            </div> <br>
                                    <div class="row hidden stud_ids">
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                          <select class="form-control chosen-select" id="student_ID" name="student_ID[]" disabled multiple>
                                          </select>
                                        </div>
                                      </div>
  			                            ...
  			                            <div class="row">
  			                              <div class="form-group">
  			                                ...
  			                                <div class="col-sm-9">
  			                                  <select class="form-control chosen-select" name="professor_ID" id="prof" disabled>
  	  										                </select>
  			                                </div>
  			                              </div>
  			                            </div> <br>
  			                            <div class="row">
  			                              <div class="form-group">
  			                                ...
  			                                <div class="col-sm-9">
  			                                  <select class="form-control chosen-select" name="Subject" id="sub" disabled>
                                          </select>
  			                                </div>
  			                              </div>
                                    </div>
                                    ...
                                    <div class="row">
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                          <select class="form-control chosen-select" name="Days[]" id="days" multiple disabled>
                                    ...
                                    <div class="row">
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                          <select class="form-control chosen-select" name="chapter[]" placeholder="chapter" id="chapter" value="" multiple required>
                                          </select>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                      ...
                                      <button id="cmt" type="button" class="btn btn-success">Communicate Daily Class Update</button>
                                    </div>
...
<script type="text/javascript">
  ...
  function edit(res)
  {
    ...
    $('#chapter_chosen').css('width', '100%').trigger('chosen:updated');
    if(res.chapter == null)
    {
      getChosenData('chapter','LS',[{'label':'name','value':'ID'}],[{'Status':'A','subject_ID':res.subject}],true);
    }
    else
    {
      getChosenData('chapter','LS',[{'label':'name','value':'ID'}],[{'Status':'A','subject_ID':res.subject}],res.chapter,true);
    }
  ...
  $("#tab_add").on('click',function(e){
    ...
    $('#Time').val('');
    $('#Totime').val('');
    $('#chapter').val('').trigger('chosen:updated');
    $('#topic').val('');
  ...
  function commun(id,lect_ID)
  {
    $.ajax({
      url:'<?php echo base_url("communicate/get_record"); ?>',
      method:'POST',
      data:{ID:id,rec_id:'CMSSK10000004',tbl:'CL'},
      datatype:'JSON',
      success:function(response){
