<div class="ibox">
  <div class="ibox-title">
      <h5><?php echo ucfirst($this->lang_library->translate('Add Chapter')); ?></h5>
...
<div class="page-content">
            <div class="wrap">
              <h4 id="success" style="text-align:center;"></h4>
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo base_url('Lesson/add'); ?>" method="post" id="bank_add">
                        <input type="hidden" name="ID" value="<?php echo @$View['ID'];?>">
                         <div class="form-group">
                              <label  class="col-sm-3 control-label">Subject Name : </label>
                              <div class="col-sm-6">
                                <select name="subject_ID" id="subject_ID" class="form-control select-chosen" required>
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input type="number" class="form-control" placeholder="Chapter Number" name="lesson_no" value="<?php echo @$View['lesson_no']; ?>">
                              </div>
                                <span id="bank_name"></span>
                          </div>
                         <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input type="text" class="form-control" placeholder="Chapter Name" name="name" value="<?php echo @$View['name']; ?>" required>
                              </div>
                                <span id="bank_name"></span>
                          </div>
...
$("#bank_add").validate();
  ...
  getChosenData('subject_ID','SB',[{'label':'name','value':'ID'}],[{'Status':'A'}],'<?php echo @$View['subject_ID']?>');</script>