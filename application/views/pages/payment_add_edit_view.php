<div class="ibox">
  <div class="ibox-title">
      <h5><?php echo ucfirst($this->lang_library->translate('Add Payment Mode')); ?></h5>
...
<div class="page-content">
            <div class="wrap">
              <h4 id="success" style="text-align:center;"></h4>
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo base_url('PaymentMode/add'); ?>" method="post" id="expense_add">
