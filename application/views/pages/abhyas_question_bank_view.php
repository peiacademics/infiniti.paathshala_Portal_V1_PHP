<div class="page-content">
  <div class="row">
    <div class="pull-right">
     <a href="<?php echo base_url('Abhyas_question_bank/add'); ?>"><button typer="button" class="btn btn-w-m btn-primary dim btn-outline"><i class="fa fa-plus"></i> Add Question Bank</button></a>
    </div>
    <div class="ibox">
...
<script type="text/javascript">
  $(document).ready(function() {
    oTable = $('#example').DataTable( {
      "processing": true,
      "serverSide": true,
      "ajax": "<?php echo base_url('Abhyas_mcq/get_show_question_bank'); ?>",
       dom: 'lBfrtip',
        buttons: [
  ...
  { 
    $.ajax({
      type:'POST',
      url: '<?php echo base_url(); ?>'+'Abhyas_mcq/view/'+id,
