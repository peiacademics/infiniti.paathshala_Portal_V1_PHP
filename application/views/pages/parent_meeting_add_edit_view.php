...
<div class="ibox">
  <div class="ibox-title">
      <h5><?php echo ucfirst($this->lang_library->translate('Add Parent Meeting')); ?></h5>
...
<div class="page-content">
            <div class="wrap">
              <h4 id="success" style="text-align:center;"></h4>
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo base_url('parent_meeting/add'); ?>" method="post" id="meeting_add">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-6">
                            <input type="text" class="form-control" id="Name" placeholder="Meeting Title" name="title" value="<?php echo @$View['title']; ?>" required>
                          </div>
                          <span id="title"></span>
                        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#meeting_add").postAjaxData(function(result){
      if( result == true)
      {
  ...
  function commun(id)
  {
    $.ajax({
      ...
      method:'POST',
      data:{ID:id,rec_id:'CMSSK10000001',tbl:'PME'},
      datatype:'JSON',
      success:function(response){
