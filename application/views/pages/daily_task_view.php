<div class="page-content">
  <div class="row">
    <div class="pull-right">
     <a href="<?php echo base_url('report/add/'.$branch_ID); ?>"><button typer="button" class="btn btn-w-m btn-primary dim btn-outline"><i class="fa fa-plus"></i> Add Daily Task</button></a>
    </div>
    <div class="ibox">
      <!-- <div class="ibox-title">
        <h5><?php echo ucfirst($this->lang_library->translate('Daily Report')); ?></h5>
      ...
      <div class="ibox-content table-responsive">
        <div>
          <!-- <a href="<?php echo base_url('report/add/'.$branch_ID); ?>" class="btn btn-w-m btn-primary">Add Daily Task</a> -->
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    oTable = $('#example').DataTable( {
      "processing": true,
      "serverSide": true,
      "ajax": "<?php echo base_url('report/get_show_data'); ?>"+'/'+branch_ID,
      dom: 'lBfrtip',
        buttons: [
