<div class="row">
  <!-- <div class="ibox-title">
      <h5><?php echo ucfirst($this->lang_library->translate('Add Abhyas PDF')); ?></h5>
    ...
    <div class="page-content">
        <div class="wrap">
          <h4 id="success" style="text-align:center;"></h4>
                <form class="form-horizontal" role="form" action="<?php echo base_url('Abhyas_pdf/add'); ?>" method="post" id="bank_add">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="" class="col-sm-3 control-label">Upload PDF</label>
                        <div class="col-sm-6">
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                            <span class="btn btn-success btn-file">
                              <span class="fileinput-new">Select file</span>
                              <span class="fileinput-exists">Change</span>
                              <input type="file" value="deepak" name=".." onChange="uploadFile(this)" <?php echo (!empty(@$View['pdf_ID']) ? '' :''); ?> />
                            </span>
                            <span class="fileinput-filename" id="file_name"><?php echo @$View['pdf_ID']; ?></span>
                        ...
                        <input type="hidden" name="pdf_ID" id="pdf_ID" value="<?php echo @$View['pdf_ID']; ?>">
                      </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#bank_add").postAjaxData(function(result){
      ...
      {
        toastr.error("Please upload PDF first!");
      }
      else
      {
  ...
  function uploadFile(f) {
    ...
    $.ajax({
      ...
      contentType: false,
      processData: false,
      url: '<?php echo base_url("Abhyas_pdf/upload_pdf");?>',
      xhr: function()
      {
